...
public class OldFileTemplateController {
    ...
    private final static Logger LOG = Logger.getLogger(OldFileTemplateController.class);
    ...
    public static DocElement getDocElement(String queryString,String dataset_id,String [] fq,String peer) {
