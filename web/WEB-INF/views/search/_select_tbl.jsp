	...
	{{if count > 0}}
		<tr style="margin-top:50px;" class="top_level_data_item"  >
			...
			<td style="width: 300px;font-size:13px">
				{{if count > 0}}
					<div style="word-wrap: break-word;font-weight:bold"  ><span class="datasetId">${datasetId}</span>
						<span class="datasetCount">(${count} files)</span> 
					</div>
				{{else}}
			...
			<td style="font-size:13px;float:right" > 
				{{if count > 0}}
					<a href="#" class="showAllChildren" id="${$item.replacePeriods(datasetId)}">Expand</a> | 
					{{if hasHttp > 0}}
		...
		<tr style="margin-top:50px;" class="top_level_data_item ${$item.replacePeriods(datasetId)}" id="${$item.replacePeriods(datasetId)}" >
			...
			<td style="font-size:13px;float:right" id="${$item.replacePeriods(datasetId)}"> 
				{{if count > 0}}
...
<script id="fInfo" type="text/x-query-tmpl">
	{{each(j) file}}
