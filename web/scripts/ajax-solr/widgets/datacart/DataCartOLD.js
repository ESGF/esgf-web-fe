				...
				success: function(data) {
					...
					*/
	                ...
	                .find( "a.showAllChildren" ).click(function() {
	                	...
	                	/*
	                	var sId = selectedItem.data.doc;
	                	for(var key in sId) {
	                		alert('key: ' + key + ' value: ' + sId[key]);
	                		for(var key2 in sId[key]) {
	                			alert(' key2: ' + key2 + ' value: ' + sId[key][key2]);
	                		}
	                	}
	                	*/
	                	
	                	//alert('selectedDocId: ' + selectedItem);
	                	
	                	//alert('tr.view_more_results_' + self.replacePeriod(selectedDocId));
	                	//$('tr.view_more_results_' + selectedDocId).toggle();
