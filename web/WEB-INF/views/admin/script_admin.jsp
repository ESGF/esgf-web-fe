...
<script type="text/javascript" src='<c:url value="/scripts/esgf/esgf-admin.js" /> '></script>

<!--
<script type="text/javascript" src='<c:url value="/scripts/jquery-1.4.2/jquery.form.js" /> '></script>
-->