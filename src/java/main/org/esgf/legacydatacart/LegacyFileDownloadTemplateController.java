...
public class LegacyFileDownloadTemplateController {
    ...
    private final static Logger LOG = Logger.getLogger(LegacyFileDownloadTemplateController.class);
    ...
    public static void main(String [] args) {
        ...
        String peer = "dev.esg.anl.gov;esg-datanode.jpl.nasa.gov";
        ...
        String fqStr = ",offset=0,replica=false,query=*";
        ...
        //mockRequest.addParameter("initialQuery","t");
        
        LegacyFileDownloadTemplateController fc = new LegacyFileDownloadTemplateController();
        ...
        if(initialQuery.equals("true")) {
            ...
            if(id != null) {
                ...
                for(int i=0;i<id.length;i++) {
                    LegacyDocElement docElement = getDocElement(queryString,id[i],peers[i],technotes[i]);
                    if(doGetDebug) {
            ...
            LegacyDocElement docElement = getDocElement(queryString,id,peerStr,technoteStr);
    ...
    public static LegacyDocElement getDocElement(String queryString,String dataset_id,String peer,String technote) {
