...
@Controller
@RequestMapping(value="/goauthview4")
public class GOauthView4Controller {


    private final static Logger LOG = Logger.getLogger(GOauthView4Controller.class);
