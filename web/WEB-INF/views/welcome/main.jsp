...
<div class="span-24 info last" >
  	...
  	<div class="prepend-2 span-20 info last">
  		...
  		This is <a href="https://github.com/ESGF/esgf.github.io/wiki/ESGF_Transition">Phase I of IV</a> that transitions away from the ESG gateway-centric system based on gateway version 1.3.4 to the new ESGF peer-to-peer system.  
  		...
  		-->
  		<!--  
  		Welcome to the beta test site for the CMIP5 distributed archive. We are now in the <a href="https://github.com/ESGF/esgf.github.io/wiki/ESGF_Transition">first of four phases</a> in transitioning from the ESG 1.3.4 gateways 
        ...
        please consult the <a href="hhttps://github.com/ESGF/esgf.github.io/wiki/ESGF_User_FAQ">TABLE OF WORKING DATA NODES</a>.  		
  		-->
  		<!--  
