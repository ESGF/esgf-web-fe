...
<div class="span-24 last" style="margin-top:20px;min-height:500px;">
	...
	<div class="prepend-1 span-24 append-1">
		<%@ include file="/WEB-INF/views/goauthview/goauth_transfer_form.jsp" %>
	</div>
</div>
...
{
 //ESGF.localStorage.remove('GO_Credential',${GoFormView_openId});
 ESGF.localStorage.put('GO_Credential',${GoFormView_openId}, ${GoFormView_UserCertificate});
 alert('online credential should be cached');
}
window.onload = addCredential;
</script>
<script>
