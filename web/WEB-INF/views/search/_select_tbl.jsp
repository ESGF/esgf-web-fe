...
<script id="cartTemplate" type="text/x-jquery-tmpl">
 	<tr class="top_level_data_item">
		<td class="left_table_header"><input class="topLevel" type="checkbox" id="${doc.id}" name="${doc.id}" checked="true" style="display:none" />${doc.id} </td><td id="${doc.id}" > <a href="#" class="showAllChildren">Expand</a> | <a href="#" class="wgetAllChildren">Download wget (${$item.sizeConversion(doc.size)})</a></td>
	</tr>
	{{each(i) doc.file_url}}
