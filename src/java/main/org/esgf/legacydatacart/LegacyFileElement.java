...
public class LegacyFileElement implements LegacyDataCartElement {
    ...
    private LegacyServicesElement servicesElement;
    private LegacyURLSElement urlsElement;
    private LegacyMIMESElement mimesElement;
    private LegacyTechnotesElement technotesElement;
    
    private String hasTechnote;
    
    public LegacyFileElement() {
    ...
    private void initialize() {
        ...
        this.mimesElement = new LegacyMIMESElement();
        this.urlsElement = new LegacyURLSElement();
        this.servicesElement = new LegacyServicesElement();
        this.technotesElement = new LegacyTechnotesElement();
    }
    
    public LegacyFileElement(JSONObject docJSON, String string) {
        if(string.equals("solr")) {
            try {
                ...
                if(!technote) {
                    this.setTechnotesElement(new LegacyTechnotesElement());
    ...
    public LegacyServicesElement getServicesElement() {
        return servicesElement;
    }
    public void setServicesElement(LegacyServicesElement servicesElement) {
    ...
    public LegacyURLSElement getUrlsElement() {
        return urlsElement;
    }
    public void setUrlsElement(LegacyURLSElement urlsElement) {
        if(urlsElement != null)
            this.urlsElement = urlsElement;
    }
    public LegacyMIMESElement getMimesElement() {
        return mimesElement;
    }
    public void setMimesElement(LegacyMIMESElement mimesElement) {
    ...
    public void addTechnote(LegacyTechnoteElement technote) {
        if(technote != null)
            this.technotesElement.addTechnoteElement(technote);
    }
    
    public boolean removeTechnote(LegacyTechnoteElement technote) {
        if(technote != null)
