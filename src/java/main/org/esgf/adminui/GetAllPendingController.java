 ...
 */
@Controller
@RequestMapping("/getallpendingproxy")
public class GetAllPendingController {
    
    private final static Logger LOG = Logger.getLogger(GetAllPendingController.class);
    ...
    public GetAllPendingController() {
        ...
        LOG.debug("IN GetAllPendingController Constructor");
    }
    ...
    public @ResponseBody String doGet(HttpServletRequest request, HttpServletResponse response) {
        LOG.debug("GetAllPendingController doGet");
    ...
    public @ResponseBody String doPost(HttpServletRequest request, HttpServletResponse response) throws IOException, JSONException, ParserConfigurationException, JDOMException {
        ...
        String errormessage = "";
        String ids = "";        
        List<String[]> groupsWithPendingMembership = null;
        boolean error = false;
