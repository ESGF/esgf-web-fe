    ...
    <link rel="stylesheet" href='<c:url value="/styles/esgf-base.css" />' type="text/css" media="screen, projection">
    
    <link rel="stylesheet" href='<c:url value="/styles/esgf-node.css" />' type="text/css" media="screen, projection">