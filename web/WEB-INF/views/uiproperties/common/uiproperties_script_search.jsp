...
<script type="text/javascript" src='<c:url value="/scripts/esgf/dynotable/highlight.min.js" /> '></script>
<script type="text/javascript" src='<c:url value="/scripts/esgf/dynotable/jquery.dynotable.js" /> '></script>
