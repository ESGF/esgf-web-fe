...
<ti:insertDefinition name="main-layout" >
    ...
    <ti:putAttribute name="main">
		...
		<div style='margin-bottom:15px'>
		<a href='https://github.com/ESGF/esgf.github.io/wiki/ESGF_Data_Download'  style='font-weight:bold'>User registration at ESGF</a>
		...
		<div style='margin-bottom:15px'>
		<a href='https://github.com/ESGF/esgf.github.io/wiki/ESGF_Data_Download'  style='font-weight:bold'>Data download from ESGF</a>
		...
		<div style='margin-bottom:15px'>
		<a href='https://github.com/ESGF/esgf.github.io/wiki/fe-user-guide' style='font-weight:bold'>ESGF Web Interface User Guide</a>
		...
		<div style='margin-bottom:15px'>
		<a href='https://github.com/ESGF/esgf.github.io/wiki/ESGF_Web_Search_User_Guide' style='font-weight:bold'>ESGF Search User Guide</a>
		<br/>A short user guide to discovering data within ESGF.  The <a href='hhttps://github.com/ESGF/esgf.github.io/wiki/ESGF_Search_REST_API' style='font-weight:bold'>ESGF Search API documentation</a> is also available for developers interested in writing their own clients. 
