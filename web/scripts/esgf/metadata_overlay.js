...
var metadataString =
	...
	'<p>'+
	'The following is a metadata summary for dataset' + '&lt;insert dataset title here&gt;' + ' with constraints: '+
	'</p>'+
	'<p>'+
...
function metadata_report(id,metadatafilename,metadatafileformat)
{
	if(popupStatusMetadataReport==0){
		$("#backgroundPopupMetadataReport").css({
			"opacity": "0.8"
