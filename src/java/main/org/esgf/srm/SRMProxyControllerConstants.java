...
public class SRMProxyControllerConstants {

    public static String INPUT_FILE_ID = "N/A";
    public static String INPUT_FILE_URL = "N/A";
    ...
    public static String INPUT_TYPE = "Dataset";
