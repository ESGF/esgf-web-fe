function submitNewGroup(){
  ...
  if( groupName == "" || groupDesc == ""){
    ...
    var jsonObj = new Object;
	  ...
	  var userinfo_url = '/esgf-web-fe/newgroupinfoproxy';
	  $.ajax({
	    type: "POST",
      url: userinfo_url,
	    async: true,
  	  ...
  	  success: function(data) {
          ...
          hideAll();
   	      $("div .success").html("Successful created new group: " + groupName + ". Policys???" );
          $("div .success").show();
        } 
        else {
   	      $("div .error").html("Creating this group has failed! " + data.EditOutput.comment);
   			  $("div .error").show();
   		  }
   	  },
