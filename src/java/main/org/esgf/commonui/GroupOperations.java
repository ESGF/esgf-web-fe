...
public class GroupOperations {
    ...
    public static List<String> getGroupIdsForUserId(String userId) {
    ...
    public static Element getGroupsForUserId(String userId) {
        System.out.println("Returning all groups for user " + userId);
     ...
     * 
     * */
    public static void editGroup(final String groupId, String groupName, String groupDescription) {
    ...
    public static Element getAllGroups() {
    ...
    /* */
    public static Group getGroupObjectFromGroupId(String groupId) {
    ...
    public static Element getGroupInfoFromGroupId(String groupId) {
    ...
    public static String getGroupNameFromGroupId(String groupId) {
