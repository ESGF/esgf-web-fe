 ...
 * ImageHandler
 * 
 * Abstracts the actions needed to open, process and save images. Since the Java Advanced 
 * Imaging and Java 2D APIs are frustratingly in flux, this is a pretty basic go-between that performs
