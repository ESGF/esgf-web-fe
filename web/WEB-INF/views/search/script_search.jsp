...
<!--  
	...
	<script type="text/javascript" src='<c:url value="/scripts/esgf/esgf-configuration.js" />'> </script>
	...
	<script type="text/javascript" src='<c:url value="/scripts/ajax-solr/widgets/URLParams.js" />'> </script>
	<script type="text/javascript" src='<c:url value="/scripts/ajax-solr/widgets/DatasetSelection.js" />'> </script>
